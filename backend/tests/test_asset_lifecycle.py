...
def _asset(factory, conversation_id=None):
    with factory() as session:
        item = lifecycle.upsert_catalog_record(
            ...
            name="AI 短剧 Skill", purpose="生成可复用短剧能力", content={"logic": "真实资产内容"}, status="committed", version=1,
...
def test_reuse_creates_reference_once(monkeypatch):
    ...
    _asset(factory, conversation_id)
