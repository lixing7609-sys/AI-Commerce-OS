...
def _classify(path: str, content: str) -> tuple[list[str], str, bool]:
    ...
    markers = (
        ...
        ("founder_v1_interaction", ("conversationattachment", "conversation_attachment", "attachment_refs", "attachment_ids", "uploadfounderimage", "globalsecretarycomposer", "sino-image", "task_complexity_router", "quick_fix_contract", "conversationresponsematches", "pendingattachments", "supports_vision", "multimodal", "metadata.get(\"images\")")),
    )
