...
export const OBJECT_WORKSPACE_VIEWS = {
  all: { title: "Object Workspace", subtitle: "全部对象", types: ["application_system", "project", "agent", "skill", "workflow", "prompt", "capability", "connector", "task", "artifact", "decision", "knowledge", "memory"] },
