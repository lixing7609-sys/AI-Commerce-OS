export function StrategicOverviewCard({ strategy }) {
  return (
    <section className="sino-strategy-card sino-strategy-card--overview" aria-label="Strategic Overview Card">
      <span className="sino-kicker">Strategic position</span><h2>战略总览</h2>
