...
export function ConversationWorkspace() {
  ...
  if (view === "settings") { main = <ModelCenter onContextChange={setSettingsContext} />; context = settingsContext ? <SettingsContext detail={settingsContext} onClose={() => setSettingsContext(null)} /> : null; }
