...
export function ConversationWorkspace() {
  ...
  if (view === "settings") { const closeSettings = () => { persistWorkspace("conversation", null); setSettingsContext(null); goHome(); }; main = <ModelCenter onContextChange={setSettingsContext} />; context = <SettingsContext detail={settingsContext} onClose={closeSettings} />; }
