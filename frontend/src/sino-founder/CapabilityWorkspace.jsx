...
export function DraftContext({ selected, busy, onApproveImplementation, onViewImplementationPlan, onReturnConversation }) {
  ...
  const pkg = implementation?.execution_package; const packageNext = pkg ? pkg.preflight_status === "ready" ? "Ready for Execution" : pkg.preflight_status === "blocked" ? "解决 Preflight 技术阻塞" : "Founder 判断 Preflight 异常" : "生成 Execution Package（执行包）";
