...
vi.mock("../services/founderAiApi.js", () => ({ createExecutionLearning: vi.fn(), getCapabilityDomains: vi.fn().mockResolvedValue({ domains: [] }), getCapabilityRepositoryAssets: vi.fn().mockResolvedValue({ assets: [] }), getFounderDrafts: vi.fn().mockResolvedValue({ drafts: [] }), getFounderDraft: vi.fn(), getLifecycleAsset: vi.fn(), getLifecycleAssets: vi.fn(), getLifecycleExecutions: vi.fn(), getLifecycleLearnings: vi.fn(), performConversationCapabilityAction: vi.fn(), reuseLifecycleAsset: vi.fn(), startLifecycleExecution: vi.fn() }));
