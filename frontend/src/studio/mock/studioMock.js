...
function seedMatrixAccounts() {
  return [
    { accountId: "matrix-1", platform: "抖音", handle: "@重生豪门官方", positioning: "都市逆袭短剧", ipId: "ip-1", followers: 486200, lastUpdatedAt: daysAgo(0.3), contentCount: 46, totalPlays: 28600000, accountHealth: "healthy", monetizationStatus: "monetized", sellableTrafficValue: 68000, authorizationStatus: "authorized", publishFrequency: "日更 1-2 条" },
    { accountId: "matrix-2", platform: "快手", handle: "重生豪门剧场", positioning: "都市逆袭短剧", ipId: "ip-1", followers: 152300, lastUpdatedAt: daysAgo(1), contentCount: 40, totalPlays: 9800000, accountHealth: "healthy", monetizationStatus: "monetized", sellableTrafficValue: 21000, authorizationStatus: "authorized", publishFrequency: "每周 5 条" },
    { accountId: "matrix-3", platform: "小红书", handle: "星辰家居研究所", positioning: "家居选购种草", ipId: "ip-2", followers: 68900, lastUpdatedAt: daysAgo(0.1), contentCount: 128, totalPlays: 4200000, accountHealth: "healthy", monetizationStatus: "in_progress", sellableTrafficValue: 9800, authorizationStatus: "authorized", publishFrequency: "日更 2-3 条" },
    { accountId: "matrix-4", platform: "视频号", handle: "锦程出海笔记", positioning: "跨境贸易纪实", ipId: "ip-3", followers: 21400, lastUpdatedAt: daysAgo(6), contentCount: 18, totalPlays: 610000, accountHealth: "attention", monetizationStatus: "not_started", sellableTrafficValue: 1200, authorizationStatus: "pending", publishFrequency: "每周 1-2 条" },
    { accountId: "matrix-5", platform: "B站", handle: "重生豪门UP主剪辑版", positioning: "都市逆袭短剧", ipId: "ip-1", followers: 9200, lastUpdatedAt: daysAgo(14), contentCount: 12, totalPlays: 380000, accountHealth: "at_risk", monetizationStatus: "not_started", sellableTrafficValue: 300, authorizationStatus: "expired", publishFrequency: "已停更" },
    { accountId: "matrix-6", platform: "视频号", handle: "AI一人公司观察", positioning: "商业观察知识IP", ipId: "ip-6", followers: 82400, lastUpdatedAt: daysAgo(0.2), contentCount: 61, totalPlays: 5600000, accountHealth: "healthy", monetizationStatus: "monetized", sellableTrafficValue: 14200, authorizationStatus: "authorized", publishFrequency: "日更 1 条" },
    { accountId: "matrix-7", platform: "B站", handle: "AI一人公司观察", positioning: "商业观察知识IP", ipId: "ip-6", followers: 45300, lastUpdatedAt: daysAgo(0.4), contentCount: 58, totalPlays: 3900000, accountHealth: "healthy", monetizationStatus: "monetized", sellableTrafficValue: 9600, authorizationStatus: "authorized", publishFrequency: "日更 1 条" },
    { accountId: "matrix-8", platform: "抖音", handle: "LightOS灯光改造", positioning: "出租屋改造种草", ipId: "ip-5", followers: 33800, lastUpdatedAt: daysAgo(0.5), contentCount: 22, totalPlays: 2100000, accountHealth: "healthy", monetizationStatus: "in_progress", sellableTrafficValue: 6200, authorizationStatus: "authorized", publishFrequency: "每周 4 条" },
    { accountId: "matrix-9", platform: "小红书", handle: "LightOS灯光改造", positioning: "出租屋改造种草", ipId: "ip-5", followers: 28900, lastUpdatedAt: daysAgo(0.1), contentCount: 30, totalPlays: 1800000, accountHealth: "healthy", monetizationStatus: "in_progress", sellableTrafficValue: 5100, authorizationStatus: "authorized", publishFrequency: "每周 5 条" },
  ];
}
...
function seedContentAssets() {
  return [
    ...
    { assetId: "asset-2", title: "星辰家居商品种草脚本模板", assetType: "脚本模板", ipId: "ip-2", copyrightStatus: "cleared", reusable: true, generationSource: "内容策划 Agent", tokenCost: 800, computeCost: 0, publishedPlatforms: [], cumulativePlays: 0, cumulativeRevenue: 0, commercialLicenseStatus: "internal_only" },
...
function seedMatrixPublishTasks() {
  return [
    { taskId: "pub-1", projectId: "proj-7", platform: "红果短剧", accountId: "matrix-1", title: "《重生后我接管了老板的公司》EP03", copy: "从今天起，这家公司由我说了算。", tags: ["逆袭", "职场"], cover: "ep03-cover.png", scheduledAt: days(0.3), abTitle: "老板消失后，我用一份协议夺回了公司", status: "scheduled", retryCount: 0, contentUrl: "", dataSyncStatus: "pending", reviewStatus: "已通过", contentVersion: "v3" },
    { taskId: "pub-2", projectId: "proj-8", platform: "抖音", accountId: "matrix-8", title: "出租屋灯光改造01", copy: "30分钟告别白炽灯", tags: ["租房好物", "氛围灯"], cover: "lightos-01-cover.png", scheduledAt: daysAgo(0.1), abTitle: "免打孔灯光改造，租期结束直接拆", status: "published", retryCount: 0, contentUrl: "https://douyin.example/demo-pub-2", dataSyncStatus: "synced", reviewStatus: "已通过", contentVersion: "v1" },
    { taskId: "pub-3", projectId: "proj-9", platform: "视频号", accountId: "matrix-6", title: "AI一人公司：员工都是Agent", copy: "一个人如何管理14个Agent同事", tags: ["AI创业"], cover: "aigongsi-cover.png", scheduledAt: daysAgo(0.2), abTitle: "我雇了14个AI员工，一分钱不发工资", status: "failed", retryCount: 1, contentUrl: "", dataSyncStatus: "pending", reviewStatus: "已通过", contentVersion: "v2" },
    { taskId: "pub-4", projectId: "proj-9", platform: "B站", accountId: "matrix-7", title: "AI一人公司：如何用 Agent 管账", copy: "把财务、客服、选品全部交给 Agent。", tags: ["AI创业", "财务自动化"], cover: "aigongsi-02-cover.png", scheduledAt: daysAgo(0.02), abTitle: "AI帮我管账后，我删除了财务这个岗位", status: "publishing", retryCount: 0, contentUrl: "", dataSyncStatus: "pending", reviewStatus: "已通过", contentVersion: "v1" },
  ];
}
